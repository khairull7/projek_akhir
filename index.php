    ...
    <div class="header-content">
      <div class="row">
        <div class="col-md-5 my-auto mx-auto" data-aos="fade-right">
          <h2>Toko Mudah</h2>
          <p>
            Toko Mudah adalah aplikasi belanja online terbesar di Indonesia.
        ...
        <div class="col-md-6 my-auto mx-auto" data-aos="zoom-in">
          <div class="d-flex justify-content-center align-items-center flex-column">
            <img src="assets/img/baju.jpg" alt="banner" class="my-5">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="footer bg-dark" id="contact">
    <div class="footer-content">
      ...
      <div class="row">
        ...
        <div class="col-md-5 my-3 mx-auto" data-aos="fade-in">
          <h4 class="text-light text-poppins font-weight-bold">Toko Mudah</h4>
          <p class="d-block font-weight-light text-light">
            Toko Mudah adalah aplikasi berbelanja online dengan fasilitas memadai
          </p>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <div class="d-flex justify-content-center align-items-center text-center flex-column mx-auto">
            <span class="d-block text-light">Toko Mudah <strong>2023</strong></span>
          </div>
        </div>
      </div>
    </div>
